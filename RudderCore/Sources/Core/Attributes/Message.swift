...
extension Message {
    ...
    func toString() throws -> String {
        guard let jsonObject = handleUrlAndDateTypes(dictionaryValue), JSONSerialization.isValidJSONObject(jsonObject) else {
            throw InternalErrors.invalidJSON
        }
    ...
    private func handleUrlAndDateTypes(_ message: [String: Any]?) -> [String: Any]? {
    ...
    private func convertIntoString(_ dictValue: inout [String: Any]) {
