...
<p align="center">
  <a href="https://cocoapods.org/pods/Rudder">
    <img src="https://img.shields.io/static/v1?label=pod&message=v1.32.1&color=blue&style=flat">
  </a>
...
```xcode
github "rudderlabs/rudder-sdk-ios" "v1.32.1"
```
...
* In **Dependency Rule**, select **Up to Next Major Version** and enter `1.32.1` as the value, as shown:
...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "git@github.com:rudderlabs/rudder-sdk-ios.git", from: "1.32.1")
    ],
    targets: [
