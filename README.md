...
```xcode
github "rudderlabs/rudder-sdk-ios" "v1.1.5"
```
...
* In **Dependency Rule**, select **Up to Next Major Version** and enter `1.1.5` as the value, as shown:
...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "git@github.com:rudderlabs/rudder-sdk-ios.git", from: "1.1.5")
    ],
    targets: [
