...
```xcode
github "rudderlabs/rudder-sdk-ios" "v1.5.0"
```
...
* In **Dependency Rule**, select **Up to Next Major Version** and enter `1.5.0` as the value, as shown:
...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "git@github.com:rudderlabs/rudder-sdk-ios.git", from: "1.5.0")
    ],
    targets: [
