...
versionFile="./Sources/Classes/Common/Constants/RSConstants.swift"
...
# update Sources/Classes/Common/Constants/RSConstants.swift
# - remove last line...
sed -i '' -e '$ d' $versionFile
# - add new line w/ new version
echo "let RSVersion = \"$newVersion\"" >> $versionFile
